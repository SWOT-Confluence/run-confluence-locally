...
from .utils.module_images import clone_repos, create_defs, create_sifs
from .utils.scripts import create_slurm_scripts, create_slurm_driver
...
def setup_modules(cfg: dict):
    ...
    for module in stripped_modules:
        create_defs(module, cfg['modules_dir'], cfg['image_release_tag'])
